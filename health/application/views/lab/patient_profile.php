        ...
        <div class="container-fluid">
            <div id="pad-wrapper" class="user-profile">
                ...
                <div class="row-fluid header">
                    ...
                    <a href=" <?php echo  site_url("lab/delete_patient/").'/'. $id; ?>" class="btn-flat icon pull-right delete-user" data-toggle="tooltip" title="Delete user" data-placement="top">
                        <i class="icon-trash"></i>
                    </a>
                   
                     <a href=" <?php echo  site_url("lab/edit_hospital_patient/").'/'. $id; ?>" class="btn btn-info large pull-right edit" >
                        Edit this person
                    </a>
                    &nbsp;
