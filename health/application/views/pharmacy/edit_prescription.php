...
<div class="control-group">
  ...
  <div class="controls">
    <input id="doctor" name="doctor" type="text" placeholder="" class="input-medium" required="">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="patient" name="patient" type="text" placeholder="" class="input-medium" required="">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="casehistory" name="casehistory" type="text" placeholder="" class="input-medium" required="">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="medication" name="medication" type="text" placeholder="" class="input-medium" required="">
