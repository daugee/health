                    ...
                    <div class="row">
                        <div class="tabbable span12">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tabs1-pane1" data-toggle="tab">Update Prescription</a></li>
                                    ...
                                    <form method="post" action="<?php echo site_url('doctor/update_prescription'); ?>" id="formID" class="form-horizontal" >					
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="doctor" name="doctor" type="text" value="<?php echo $name; ?>" class="input-medium" readonly>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="casehistory" name="casehistory" type="text"value="<?php echo $query[0]['casehistory']; ?>" class="input-medium">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="medication" name="medication" type="text" value="<?php echo $query[0]['medication']; ?>" class="input-medium" >
