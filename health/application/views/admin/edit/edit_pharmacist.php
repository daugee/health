                    ...
                    <div class="row">
                        <div class="tabbable span12">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tabs1-pane1" data-toggle="tab">Edit Pharmacist </a></li>
                                <li><a href="#tabs1-pane2" data-toggle="tab">pharmacist List</a></li>

                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="tabs1-pane1">
                                    <form method="post" action="<?php echo site_url('admin/edit_pharmacist/'.$query[0]['id'].''); ?>" id="formID" class="form-horizontal" >					
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="Patient Name" name="pharmacistname" type="text"  class="input-medium" required="" value="<?php echo $query[0]['name']; ?>">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <button id="add" name="update" class="btn btn-primary">Update Pharmacist</button>
                                                </div>
                                            </div>
