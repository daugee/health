                ...
                <div class="row-fluid form-wrapper">
                    ...
                    if (isset($flash)) {
                        if ($flash == TRUE) {
                            echo '<div class="alert alert-success">';
                            echo '<a class="close" data-dismiss="alert">×</a>';
                            echo '<strong>Well done!</strong> Nurse details  has been updated successfully.';
                            echo '</div>';
                        } else {
                            echo '<div class="alert alert-error">';
                            echo '<a class="close" data-dismiss="alert">×</a>';
                            echo '<strong>Oh snap!</strong> The was a problem updating.';
                            echo '</div>';
                        }
                    }
                    ?>
                    ...
                    if (isset($flash_msg)) {
                        if ($flash_msg== TRUE) {
                            echo '<div class="alert alert-success">';
                            echo '<a class="close" data-dismiss="alert">×</a>';
                            echo '<strong>Well done!</strong> Nurse been removed from system successfully.';
                            echo '</div>';
                        } else {
                            echo '<div class="alert alert-error">';
                            echo '<a class="close" data-dismiss="alert">×</a>';
                    ...
                    <div class="row">
                        <div class="tabbable span12">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tabs1-pane1" data-toggle="tab">nurse list</a></li>
                                <li><a href="#tabs1-pane2" data-toggle="tab">add nurse</a></li>
...
<a href="javascript:demoFromHTML()" class="button" style="alignment-adjust:middle" target=" " ><button>Print report</button></a>
                  ...
                  <a href="' . site_url("admin") . '/nurse_update/' . $row['id'] . '" class="btn btn-info">view & edit</a>  
                  <a href="' . site_url("admin") . '/delete_nurse/' . $row['id'] . '" class="btn btn-danger">delete</a>
                </td>';
                                            echo '</tr>';
                                        }
                                        ?>      
                                ...
                                <div class="tab-pane" id="tabs1-pane2">
                                    <form method="post" action="<?php echo site_url('admin/add_nurse'); ?>" id="formID" class="form-horizontal" >					
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="Patient Name" name="nursename" type="text"  class="input-medium" required="" value="<?php echo set_value('patientname'); ?>">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <button id="add" name="add" class="btn btn-primary">Add nurse</button>
                                                </div>
                                            </div>
